...
namespace phoenix::graphics::d3d12::core
{
	...
	bool initialize()
	{
...
#ifdef _DEBUG
		{
			...
			{
				OutputDebugStringA("Warning: D3D12 Debug Interface is not available. Verify that Graphics Tool optional feature is installed in this system.\n");
			}
	...
	void create_a_root_signature2()
	{
		...
		d3dx::d3d12_root_signature_desc root_signature_desc{ &params[0], _countof(params) };
	...
	void create_a_pipeline_state_object()
	{
		...
		stream.root_signature.root_signature = _root_signature;
	...
	void create_a_pipeline_state_object2()
	{
		struct
		{
			d3dx::d3d12_pipeline_state_subobject_root_signature root_signature{ _root_signature };
