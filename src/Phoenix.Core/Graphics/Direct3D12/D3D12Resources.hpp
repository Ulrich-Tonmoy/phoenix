...
namespace phoenix::graphics::d3d12
{
	...
	struct descriptor_handle
	{
		...
		constexpr bool is_sahder_visible() const { return gpu.ptr != 0; }
	...
	public:
		...
		constexpr D3D12_CPU_DESCRIPTOR_HANDLE rtv(u32 mip_index) const
		{
			assert(mip_index < _mip_count);
			return _rtv[mip_index].cpu;
		}
