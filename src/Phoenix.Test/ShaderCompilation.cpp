...
#include "Graphics/Direct3D12/D3D12Core.hpp"
#include "Graphics/Direct3D12/D3D12Shaders.hpp"
#include "ShaderCompilation.hpp"

using namespace phoenix;
using namespace phoenix::graphics::d3d12::shaders;
...
namespace
{
	...
	constexpr const char* shaders_source_path{ "../../Phoenix.Core/Graphics/Direct3D12/Shaders/" };
	...
	{
		auto engine_shaders_path = get_engine_shader_path();
